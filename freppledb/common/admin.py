...
from freppledb.common.models import User, Parameter, Comment, Bucket, BucketDetail, DataStagingLog
...
class Parameter_admin(MultiDBModelAdmin):
    ...
    exclude = ('source',)
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:common_parameter_change",
...
class DataStagingLog_admin(MultiDBModelAdmin):
    model = DataStagingLog
    save_on_top = True
    exclude = ('source',)
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:common_datastaginglog_change",
         "permission": 'common.change_datastaginglog'},
    ]

    def save_model(self, request, obj, form, change):
        obj.create_user_nr = request.user.username
        super().save_model(request, obj, form, change)


data_site.register(DataStagingLog, DataStagingLog_admin)
...
class BucketDetail_admin(MultiDBModelAdmin):
    ...
    exclude = ('source', 'id')
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:common_bucketdetail_change",
...
class Bucket_admin(MultiDBModelAdmin):
    ...
    exclude = ('source',)
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:common_bucket_change",
