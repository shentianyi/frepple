...
function popClick(win, id) {
    ...
    if (displayInput !== null) {
        ...
        var showInput = opener.document.createElement('input');
        showInput.type = "text";
...
var grid = {
    ...
    setSelectedRow: function (id) {
        ...
        $(this).jqGrid('setCell', id, 'select', '<input type="checkbox" onClick="popClick(window, grid.selected);" class="btn btn-primary" style="width: 18px; height: 18px;" data-toggle="tooltip" title="' + gettext('Click to select record') + '"></input>');
    },
            ...
            if (colmodel.formatoptions['srcformat'] == "Y-m-d")
                $("#" + iRow + '_' + cellname).on('focusin', function () {
                    ...
                    $(this).datetimepicker({
                        ...
                        widgetPositioning: {horizontal: 'auto', vertical: (iRow < 11 ? 'bottom' : 'auto')}
                    });
                });
            else
                $("#" + iRow + '_' + cellname).on('focusin', function () {
    ...
    showBucket: function () {
        ...
        $("#horizonstart").datetimepicker({
            format: 'YYYY-MM-DD',
            calendarWeeks: true,
            icons: iconslist,
            locale: document.documentElement.lang
        });
        $("#horizonend").datetimepicker({
            format: 'YYYY-MM-DD',
            calendarWeeks: true,
            icons: iconslist,
            locale: document.documentElement.lang
    ...
    showEdit: function () {
        if ($('#edit_selected').hasClass("disabled")) return;
        var sel = jQuery("#grid").jqGrid('getGridParam', 'selarrrow');
        if (sel.length == 1) {
    ...
    markSelectedRow: function (sel) {
        ...
        if (sel > 0) {
            ...
            $("#reject_selected").prop('disabled', false).addClass("bold");
            $("#approval_selected").prop('disabled', false).addClass("bold");
            $("#pass_selected").prop('disabled', false).addClass("bold");
...
var wizard = {
    wizdict: {
        "Introduction": {
            ...
            "cup": "",
            "anchor": "",
            "docanchor": "introductiondoc",
            "url_doc": "/user-guide/modeling-wizard/concepts.html",
            "url_internaldoc": null
        },
        "Master data": {
            "lock": "",
            "rctg": "basicdata",
            "cup": "",
            "anchor": "",
            "docanchor": "basicdatadoc",
            "url_doc": "/user-guide/modeling-wizard/master-data/index.html",
            "url_internaldoc": null
        },
        "Items": {
            "lock": "",
            ...
            "anchor": "itemsurl",
            "docanchor": "itemsdoc",
            "url_doc": "/user-guide/modeling-wizard/master-data/items.html",
            "url_internaldoc": "/data/input/item/"
        },
        "Locations": {
            "lock": "",
            "rctg": "locations",
            "cup": "",
            "anchor": "locationsurl",
            "docanchor": "locationsdoc",
            "url_doc": "/user-guide/modeling-wizard/master-data/locations.html",
            "url_internaldoc": "/data/input/location/"
        },
        "Customers": {
            "lock": "",
            "rctg": "customers",
            "cup": "",
            "anchor": "customersurl",
            "docanchor": "customersdoc",
            "url_doc": "/user-guide/modeling-wizard/master-data/customers.html",
            "url_internaldoc": "/data/input/customer/"
        },
        "Sales orders": {
            "lock": "lock0",
            "rctg": "salesorders",
            "cup": "",
            "anchor": "salesordersurl",
            "docanchor": "salesordersdoc",
            "url_doc": "/user-guide/modeling-wizard/master-data/sales-orders.html",
            "url_internaldoc": "/data/input/demand/"
        },
        "Buffers": {
            "lock": "lock10",
            "rctg": "buffers",
            "cup": "",
            "anchor": "bufferssurl",
            "docanchor": "bufferssdoc",
            "url_doc": "/user-guide/modeling-wizard/master-data/buffers.html",
            "url_internaldoc": "/data/input/buffer/"
        },
        "Sales orders history": {
            "lock": "lock1",
            "rctg": "salesordershistory",
            "cup": "",
            "anchor": "salesordershistoryurl",
            "docanchor": "salesordershistorydoc",
            "url_doc": "/user-guide/modeling-wizard/master-data/sales-orders.html",
            "url_internaldoc": "/data/input/demand/"
        },
        "Statistical Forecast": {
            "lock": "",
            "rctg": "statisticalforecast",
            "cup": "cup0",
            "anchor": "statisticalforecasturl",
            "docanchor": "statisticalforecastdoc",
            "url_doc": "/user-guide/model-reference/forecast.html",
            "url_internaldoc": "/forecast/"
        },
        "Inventory Planning": {"lock": "", "rctg": "inventoryplanning", "cup": "", "anchor": "", "docanchor": ""},
        "Inventory Plan Parameters": {
            "lock": "lock2",
            "rctg": "inventoryplanparameters",
            "cup": "",
            "anchor": "inventoryplanparametersurl",
            "docanchor": "inventoryplanparametersdoc",
            "url_doc": "/user-guide/modeling-wizard/inventory-planning/inventory-planning-parameters.html",
            "url_internaldoc": "/data/inventoryplanning/inventoryplanning/"
        },
        "Safety Stock": {
            "lock": "",
            "rctg": "safetystock",
            "cup": "cup1",
            "anchor": "safetystockurl",
            "docanchor": "safetystockdoc",
            "url_doc": "/user-guide/modeling-wizard/generate-plan.html",
            "url_internaldoc": "/flowplan/"
        },
        ...
        "Purchasing": {
            ...
            "cup": "",
            "anchor": "",
            "docanchor": "purchaseordersdoc",
            "url_doc": "/user-guide/modeling-wizard/purchasing/index.html",
            "url_internaldoc": null
        },
        "Suppliers": {
            "lock": "lock3",
            ...
            "cup": "",
            "anchor": "suppliersurl",
            "docanchor": "suppliersdoc",
            "url_doc": "/user-guide/modeling-wizard/purchasing/suppliers.html",
            "url_internaldoc": "/data/input/supplier/"
        },
        "Item suppliers": {
            "lock": "lock4",
            "rctg": "itemsuppliers",
            "cup": "",
            "anchor": "itemsuppliersurl",
            "docanchor": "itemsuppliersdoc",
            "url_doc": "/user-guide/modeling-wizard/purchasing/item-suppliers.html",
            "url_internaldoc": "/data/input/itemsupplier/"
        },
        "Distribution": {
            "lock": "",
            "rctg": "distribution",
            "cup": "",
            "anchor": "",
            "docanchor": "distributionordersdoc",
            "url_doc": "/user-guide/modeling-wizard/distribution/index.html",
            "url_internaldoc": null
        },
        "Item distributions": {
            "lock": "lock5",
            "rctg": "itemdistributions",
            "cup": "",
            "anchor": "itemdistributionsurl",
            "docanchor": "itemdistributionsdoc",
            "url_doc": "/user-guide/modeling-wizard/distribution/item-distributions.html",
            "url_internaldoc": "/data/input/itemdistribution/"
        },
        "Manufacturing BOM": {
            "lock": "",
            "rctg": "manufacturingbom",
            "cup": "",
            "anchor": "",
            "docanchor": "manufacturingordersdoc",
            "url_doc": "/user-guide/modeling-wizard/manufacturing-bom/index.html",
            "url_internaldoc": null
        },
        "Operations": {
            "lock": "lock6",
            "rctg": "operations",
            "cup": "",
            "anchor": "operationsurl",
            "docanchor": "operationsdoc",
            "url_doc": "/user-guide/modeling-wizard/manufacturing-bom/operations.html",
            "url_internaldoc": "/data/input/operation/"
        },
        "Operation materials": {
            "lock": "lock7",
            "rctg": "operationmaterials",
            "cup": "",
            "anchor": "operationmaterialsurl",
            "docanchor": "operationmaterialsdoc",
            "url_doc": "/user-guide/modeling-wizard/manufacturing-bom/operation-materials.html",
            "url_internaldoc": "/data/input/operationmaterial/"
        },
        "Manufacturing Capacity": {
            "lock": "",
            "rctg": "capacityplanning",
            "cup": "",
            "anchor": "",
            "docanchor": "capacityplanningdoc",
            "url_doc": "/user-guide/modeling-wizard/manufacturing-capacity/index.html",
            "url_internaldoc": null
        },
        "Resources": {
            "lock": "lock8",
            ...
            "cup": "",
            "anchor": "resourcesurl",
            "docanchor": "resourcesdoc",
            "url_doc": "/user-guide/modeling-wizard/manufacturing-capacity/resources.html",
            "url_internaldoc": "/data/input/resource/"
        },
        "Operation Resources": {
            "lock": "lock9",
            "rctg": "operationresources",
            "cup": "",
            "anchor": "operationresourcesurl",
            "docanchor": "operationresourcesdoc",
            "url_doc": "/user-guide/modeling-wizard/manufacturing-capacity/operation-resources.html",
            "url_internaldoc": "/data/input/operationresource/"
        },
        "Plan generation": {
            "lock": "",
            "rctg": "generateplan",
            "cup": "",
            "anchor": "generateplanurl",
            "docanchor": "generateplandoc",
            "url_doc": "/user-guide/modeling-wizard/generate-plan.html",
            "url_internaldoc": ""
        },
        "Distribution orders": {
            ...
            "cup": "cup2",
            "anchor": "plan_dourl",
            "docanchor": "plan_dodoc",
            "url_doc": "/user-guide/modeling-wizard/distribution/distribution-orders.html",
            "url_internaldoc": "/data/input/distributionorder/"
        },
        "Purchase orders": {
            "lock": "",
            "rctg": "plan_po",
            "cup": "cup3",
            "anchor": "plan_pourl",
            "docanchor": "plan_podoc",
            "url_doc": "/user-guide/modeling-wizard/purchasing/purchase-orders.html",
            "url_internaldoc": "/data/input/purchaseorder/"
        },
        "Manufacturing orders": {
            ...
            "cup": "cup4",
            "anchor": "plan_mourl",
            "docanchor": "plan_modoc",
            "url_doc": "/user-guide/modeling-wizard/manufacturing-bom/manufacturing-orders.html",
            "url_internaldoc": "/data/input/manufacturingorder/"
        }
    },
