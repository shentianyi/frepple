    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ship_address', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='ship address')),
                ('description', models.CharField(blank=True, max_length=500, null=True, verbose_name='description')),
                ('category', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='category')),
                ('subcategory', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='subcategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(db_index=True, default=django.utils.timezone.now, editable=False, verbose_name='updated_at')),
                ('id', models.AutoField(help_text='Unique identifier', primary_key=True, serialize=False, verbose_name='id')),
                ('year', models.IntegerField(db_index=True, max_length=300, verbose_name='year')),
                ...
                ('status', models.CharField(choices=[('init', 'forecast init'), ('ok', 'forecast ok'), ('nok', 'forecast nok'), ('cancel', 'forecast cancel'), ('release', 'forecast release'), ('confirm', 'forecast confirm')], default='init', max_length=20, verbose_name='status')),
            ...
            bases=(models.Model, freppledb.input.models.ForecastCommentOperation),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(db_index=True, default=django.utils.timezone.now, editable=False, verbose_name='updated_at')),
                ('id', models.AutoField(help_text='Unique identifier', primary_key=True, serialize=False, verbose_name='id')),
                ('nr', models.CharField(db_index=True, max_length=300, unique=True, verbose_name='item nr')),
                ('name', models.CharField(db_index=True, max_length=300, verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(db_index=True, default=django.utils.timezone.now, editable=False, verbose_name='updated_at')),
                ('id', models.AutoField(help_text='Unique identifier', primary_key=True, serialize=False, verbose_name='id')),
                ('nr', models.CharField(db_index=True, max_length=300, unique=True, verbose_name='supplier nr')),
                ('name', models.CharField(db_index=True, max_length=300, verbose_name='name')),
                ('area', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='area')),
                ('address', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='address')),
                ('ship_address', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='ship address')),
        ...
        migrations.AddField(
            model_name='forecast',
            name='version',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='forecast_version', to='input.ForecastVersion', verbose_name='forecast version'),
        ),
        migrations.AddField(
            model_name='demand',
            name='item',
