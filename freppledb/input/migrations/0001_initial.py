# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-10-15 19:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_nr', models.CharField(db_index=True, max_length=300, verbose_name='project nr')),
                ('mpq', models.IntegerField(blank=True, null=True, verbose_name='mpq')),
                ...
                ('plan_list_date', models.DateTimeField(db_index=True, editable=False, verbose_name='plan list date')),
                ('plan_delist_date', models.DateTimeField(db_index=True, editable=False, verbose_name='plan delist date')),
                ('category', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='category')),
                ('subcategory', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='subcategory')),
                ('description', models.CharField(blank=True, max_length=500, null=True, verbose_name='description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(db_index=True, default=django.utils.timezone.now, editable=False, verbose_name='updated_at')),
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='identifier')),
                ('leadtime', models.DurationField(blank=True, help_text='Purchasing lead time', null=True, verbose_name='lead time')),
                ('sizeminimum', models.DecimalField(blank=True, decimal_places=8, default='1.0', help_text='A minimum purchasing quantity', max_digits=20, null=True, verbose_name='size minimum')),
                ('sizemultiple', models.DecimalField(blank=True, decimal_places=8, help_text='A multiple purchasing quantity', max_digits=20, null=True, verbose_name='size multiple')),
                ('cost', models.DecimalField(blank=True, decimal_places=8, help_text='Purchasing cost per unit', max_digits=20, null=True, verbose_name='cost')),
                ('priority', models.IntegerField(blank=True, default=1, help_text='Priority among all alternates', null=True, verbose_name='priority')),
                ('effective_start', models.DateTimeField(blank=True, help_text='Validity start date', null=True, verbose_name='effective start')),
                ('effective_end', models.DateTimeField(blank=True, help_text='Validity end date', null=True, verbose_name='effective end')),
                ('resource_qty', models.DecimalField(blank=True, decimal_places=8, default='1.0', help_text='Resource capacity consumed per purchased unit', max_digits=20, null=True, verbose_name='resource quantity')),
                ('fence', models.DurationField(blank=True, help_text='Frozen fence for creating new procurements', null=True, verbose_name='fence')),
        ...
        migrations.AddField(
            ...
            name='location',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='itemsuppliers', to='input.Location', verbose_name='location'),
        ),
        migrations.AddField(
            model_name='itemsupplier',
            name='resource',
            field=models.ForeignKey(blank=True, help_text='Resource to model the supplier capacity', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='itemsuppliers', to='input.Resource', verbose_name='resource'),
        ),
        migrations.AddField(
            model_name='itemsupplier',
            name='supplier',
