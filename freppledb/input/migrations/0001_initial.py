# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-10-25 10:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='category')),
                ('subcategory', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='subcategory')),
                ('unit_min_num', models.DecimalField(blank=True, decimal_places=8, max_digits=20, null=True, verbose_name='unit min num')),
                ('unit_max_num', models.DecimalField(blank=True, decimal_places=8, max_digits=20, null=True, verbose_name='unit max num')),
                ('unit_num_multiple', models.DecimalField(blank=True, decimal_places=8, max_digits=20, null=True, verbose_name='unit num multiple')),
                ('unit_cost', models.DecimalField(blank=True, decimal_places=8, max_digits=20, null=True, verbose_name='unit cost')),
                ('unit_duration', models.DurationField(blank=True, null=True, verbose_name='unit duration')),
                ('effective_start', models.DateTimeField(blank=True, help_text='Validity start date', null=True, verbose_name='effective start')),
                ('effective_end', models.DateTimeField(blank=True, help_text='Validity end date', null=True, verbose_name='effective end')),
                ('alternative_process_mode', models.CharField(blank=True, choices=[('priority', 'priority'), ('mincost', 'mincost')], max_length=20, null=True, verbose_name='alternative process mode')),
                ('available', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='process_location', to='input.Calendar', verbose_name='location')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='process_location', to='input.Location', verbose_name='location')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.AutoField(help_text='Unique identifier', primary_key=True, serialize=False, verbose_name='id')),
                ('nr', models.CharField(db_index=True, max_length=300, unique=True, verbose_name='nr')),
                ('name', models.CharField(help_text='Unique identifier', max_length=300, verbose_name='name')),
                ('category', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='category')),
                ('subcategory', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='subcategory')),
                ('description', models.CharField(blank=True, max_length=500, null=True, verbose_name='description')),
            ],
