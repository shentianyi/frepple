# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-10-19 20:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(db_index=True, default=django.utils.timezone.now, editable=False, verbose_name='updated_at')),
                ('id', models.AutoField(help_text='Unique identifier', primary_key=True, serialize=False, verbose_name='id')),
                ('client_item_nr', models.CharField(blank=True, db_index=True, max_length=300, null=True, verbose_name='client item nr')),
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='itemsclients_client', to='input.Customer', verbose_name='client')),
            ],
            options={
                'verbose_name': 'item client',
                'verbose_name_plural': 'item clients',
                'db_table': 'itemclient',
                'ordering': ['id'],
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ratio', models.DecimalField(decimal_places=8, default=100, max_digits=20, verbose_name='ratio')),
                ('effective_start', models.DateTimeField(blank=True, help_text='Validity start date', null=True, verbose_name='effective start')),
                ('effective_end', models.DateTimeField(blank=True, help_text='Validity end date', null=True, verbose_name='effective end')),
        ...
        migrations.AddField(
            ...
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='itemclients_location', to='input.Location', verbose_name='location'),
        ),
        migrations.AddField(
            model_name='itemclient',
            name='product_item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='itemclients_product_item', to='input.Item', verbose_name='product item'),
        ),
        migrations.AddField(
            model_name='itemclient',
            name='sale_item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='itemclients_item', to='input.Item', verbose_name='sale item'),
        ),
        migrations.AddField(
            model_name='demand',
            name='item',
