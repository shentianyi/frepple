# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-10-23 13:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ratio', models.DecimalField(decimal_places=8, default='100.0', max_digits=20, verbose_name='ratio')),
                ('effective_start', models.DateTimeField(blank=True, help_text='Validity start date', null=True, verbose_name='effective start')),
                ('effective_end', models.DateTimeField(blank=True, help_text='Validity end date', null=True, verbose_name='effective end')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='resource_location', to='input.Location', verbose_name='location')),
        ...
        migrations.AddField(
            model_name='resource',
            name='setupmatrix',
            field=models.ForeignKey(blank=True, help_text='Setup matrix defining the conversion time and cost', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='resource_setupmatrix', to='input.SetupMatrix', verbose_name='setup matrix'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='itemcustomer',
            name='sale_item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='itemcustomer_item', to='input.Item', verbose_name='sale item'),
        ),
        migrations.AddField(
            model_name='demand',
            name='item',
