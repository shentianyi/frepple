# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-10-26 16:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_number', models.IntegerField(db_index=True, verbose_name='data number')),
                ('data_type', models.CharField(blank=True, choices=[('W', 'W'), ('M', 'M')], default='W', max_length=20, null=True, verbose_name='data_type')),
        ...
        migrations.AddField(
            model_name='forecast',
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='forecast_locatoin', to='input.Location', verbose_name='location'),
        ),
        migrations.AddField(
            model_name='demand',
            name='item',
