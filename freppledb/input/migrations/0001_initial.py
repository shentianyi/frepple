    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_time', models.DecimalField(blank=True, decimal_places=8, max_digits=20, null=True, verbose_name='product time')),
                ('load_time', models.DecimalField(blank=True, decimal_places=8, max_digits=20, null=True, verbose_name='load time')),
                ('transit_time', models.DecimalField(blank=True, decimal_places=8, max_digits=20, null=True, verbose_name='transit time')),
                ('receive_time', models.DecimalField(blank=True, decimal_places=8, max_digits=20, null=True, verbose_name='receive time')),
                ('mpq', models.DecimalField(blank=True, decimal_places=8, max_digits=20, null=True, verbose_name='mpq')),
