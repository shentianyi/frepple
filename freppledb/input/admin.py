...
class CalendarBucket_admin(MultiDBModelAdmin):
    ...
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:input_calendarbucket_change",
...
class Calendar_admin(MultiDBModelAdmin):
    ...
    exclude = ('source',)
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:input_calendar_change",
...
class Location_admin(MultiDBModelAdmin):
    ...
    exclude = ('source',)
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:input_location_change",
        ...
        {"name": 'outboundorders', "label": _("outbound distribution"),
         "view": "input_distributionorder_out_by_location"},
        {"name": 'manufacturingorders', "label": _("manufacturing orders"),
...
class Customer_admin(MultiDBModelAdmin):
    ...
    exclude = ('source',)
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:input_customer_change",
...
class Supplier_admin(MultiDBModelAdmin):
    ...
    exclude = ('source',)
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:input_supplier_change",
...
data_site.register(ItemSuccessor, ItemSuccessor_admin)
...
class SetupRule_admin(MultiDBModelAdmin):
    ...
    exclude = ('source',)
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:input_setuprule_change",
...
class ResourceSkill_admin(MultiDBModelAdmin):
    ...
    exclude = ('source',)
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:input_resourceskill_change",
...
class Resource_admin(MultiDBModelAdmin):
    ...
    exclude = ('source',)
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:input_resource_change",
...
class ManufacturingOrder_admin(MultiDBModelAdmin):
    ...
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:input_manufacturingorder_change",
...
class DistributionOrder_admin(MultiDBModelAdmin):
    ...
    tabs = [
        {"name": 'edit', "label": _("edit"), "view": "admin:input_distributionorder_change",
